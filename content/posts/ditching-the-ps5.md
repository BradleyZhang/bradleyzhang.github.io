+++ 
draft = true
date = 2026-07-13T23:33:23+08:00
title = ""
description = "逃离 PlayStation:尝试配置Bazzite 和 Windows获得主机体验"
slug = ""
authors = []
tags = []
categories = []
...
万恶的索尼居然不再出盘了，加上新游戏价格是 Steam 两倍的 PSN 商店，已经没什么理由在2028后留在 PS 了，那么来到 PC 用 Steam 怎么获得和游戏机一样的体验呢。
...
### 睡眠
Windows 的睡眠测试随便找了部，Death end re;Quest，在开场直接挂起系统再唤醒，效果和主机是一样的。长时间的睡眠稳定性没有测试，等哪天有必须在PC上玩的游戏再说。
## 最后
虽然我手上现有的笔记本没法配置出 PS 一样的体验，但距离2028还有几年，加上我除了特别喜欢的系列新作会第一时间玩外都要至少等几年再玩（而且特别喜欢的系列也不到5个），所以也至少2029前会留在ps5。希望到时候现在的问题都已经被解决并且AI热潮散去，让硬件回归正常价格吧🙏，再许愿硬件回归正常后V社贴钱做一个高性价比的 Steam Machine ，哪怕加上限制阻止刷机其他系统也好啊